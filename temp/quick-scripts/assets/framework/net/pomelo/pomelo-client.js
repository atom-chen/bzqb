(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/framework/net/pomelo/pomelo-client.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '8aa0c3wOUpLcbS+RgijauSi', 'pomelo-client', __filename);
// framework/net/pomelo/pomelo-client.js
...
(function () {
  ...
  var send = function send(packet) {
    ...
    if (socket && (typeof socket === 'undefined' ? 'undefined' : _typeof(socket)) == 'object' && socket.readyState === 1) {
